...
Not all search clauses are created equal. Literally, there are different types of Lucene queries. If you recall from the Lucene section, 
...
In the diagram above you can see the different types of Lucene Query Objects
